...
export function ProductTabs({ product }: { product: TabProduct }) {
  const tabs = [
    'Descripción',
    'Ficha técnica',
    'Modo de uso',
          ...
          <div>
            {product.descripcion_larga ? (
              <>
                ...
                >
                  Una fórmula nacida del{' '}
                  <em className="italic text-[var(--blue-deep)]">oficio metalúrgico</em>
                </h3>
                <p className="text-[15.5px] text-[var(--ink-700)] leading-[1.78] mb-4">
                  {product.descripcion_larga}
                </p>
              </>
            ) : (
            ...
            <div className="rounded-[var(--r-lg)] overflow-hidden border border-[var(--line)]">
              {(
                [
                  ...
                  ['Empresa formuladora', 'Grupo Lambea S.L.'],
            ...
            <div className="mb-8">
              {[
                ...
                },
                {
                  ...
                  badge: '4 €',
                  lines: [
                    'Tarifa única de 4 € para envíos a Baleares.',
            ...
            <div className="pt-6" style={{ borderTop: '1px solid var(--line)' }}>
              ...
              <div className="mt-5 pt-4" style={{ borderTop: '1px solid var(--line)' }}>
                <p className="text-[13px] text-[var(--ink-500)]">
                  ...
                  <a href="mailto:francisco@grupolambea.com" className="text-[var(--blue)] hover:underline">
                    francisco@grupolambea.com
                  </a>{' '}
                  o llama al{' '}
                  <a href="tel:637916345" className="text-[var(--blue)] hover:underline">
                    637 916 345
                  </a>.
                </p>
              </div>
