...
export function SiteHeader() {
  ...
  function submitSearch(e: React.FormEvent) {
    ...
    if (q.includes('barco') || q.includes('náutico') || q.includes('nautico')) {
      router.push('/tienda/nautico');
      return;
    }
    if (q.includes('caravana') || q.includes('camper') || q.includes('furgo')) {
      router.push('/tienda/caravaning');
      return;
    }
    if (q.includes('industrial') || q.includes('taller') || q.includes('camion')) {
      router.push('/tienda/industrial');
      return;
    }
    router.push(`/tienda/nautico?q=${encodeURIComponent(q)}`);
  }
