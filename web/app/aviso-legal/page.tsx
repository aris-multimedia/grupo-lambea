...
export const metadata: Metadata = {
  title: 'Aviso Legal — Grupo Lambea',
  description: 'Aviso legal de Grupo Lambea (TECNICLAM 2016 SL). Información sobre titularidad, condiciones de uso y propiedad intelectual.',
      ...
      <div className="max-w-[820px] mx-auto px-8 py-16 text-[var(--ink-700)]">
        ...
        <section className="mb-8">
          ...
          <p className="text-[15px] leading-[1.8] mb-3">
            El acceso y uso del sitio web <strong>grupolambea.com</strong> es responsabilidad exclusiva del usuario. El mero acceso no implica ninguna relación comercial entre el usuario y TECNICLAM 2016 SL.
          </p>
          <p className="text-[15px] leading-[1.8] mb-3">
          ...
          <p className="text-[15px] leading-[1.8]">
            TECNICLAM 2016 SL se reserva el derecho de modificar las condiciones de uso en cualquier momento y sin previo aviso. El uso continuado del sitio tras cualquier modificación implica la aceptación de los nuevos términos.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-[15px] leading-[1.8] mb-3">
            TECNICLAM 2016 SL no se responsabiliza de interrupciones del servicio, fallos técnicos, pérdida de datos, ataques informáticos ni daños causados por terceros ajenos a la empresa.
          </p>
          <p className="text-[15px] leading-[1.8]">
        ...
        <section className="mb-8">
          ...
          <p className="text-[15px] leading-[1.8]">
            Todo el contenido y diseño del sitio web —textos, imágenes, logotipos, marcas, fórmulas y código fuente— es propiedad exclusiva de TECNICLAM 2016 SL o cuenta con la correspondiente autorización de uso. Su reproducción, distribución o comunicación pública requiere autorización expresa y por escrito del titular.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-[15px] leading-[1.8]">
            Los enlaces a sitios web de terceros tienen carácter meramente informativo y no implican respaldo ni responsabilidad por parte de TECNICLAM 2016 SL sobre su contenido.
          </p>
        </section>
