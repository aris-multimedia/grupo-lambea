...
import { subtotal, totalDiscount, total } from '@/lib/cart';
...
export default function CheckoutPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // redirect() throws internally; if it's not a redirect, show error
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <section className="bg-white rounded-xl border border-[var(--line)] p-6">
            ...
            <p className="text-[13px] text-[var(--ink-500)] mb-4">
              Recibirás los datos de pago por email tras confirmar el pedido. Aceptamos transferencia bancaria y Bizum.
            </p>
            ...
            <div className="space-y-2 text-[13px] pt-4" style={{ borderTop: '1px solid var(--line)' }}>
              ...
              {disc > 0 && (
                <div className="flex justify-between text-[#92400e] font-semibold">
                  <span className="flex items-center gap-1"><Tag size={11} /> Promo 3×2</span>
