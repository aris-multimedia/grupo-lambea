...
export const metadata: Metadata = {
  title: 'Política de Cookies — Grupo Lambea',
    ...
    <>
      ...
      <div className="max-w-[820px] mx-auto px-8 py-16 text-[var(--ink-700)]">
        ...
        <p className="text-[15px] leading-[1.8] mb-10">
          En cumplimiento del Real Decreto-ley 13/2012 y el Reglamento UE 2016/679 (RGPD), informamos sobre el uso de cookies en el sitio web de <strong>Grupo Lambea</strong> (TECNICLAM 2016 SL).
        </p>
        ...
        <section>
          ...
          <p className="text-[15px] leading-[1.8] mt-3">
            Para cualquier consulta: <a href="mailto:francisco@grupolambea.com" className="text-[var(--blue)] no-underline hover:underline">francisco@grupolambea.com</a> · 637 916 345 · Calle Caserna 48, CP 43877 Sant Jaume d'Enveja.
          </p>
        </section>
