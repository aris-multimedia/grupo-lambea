...
DO $$ DECLARE pid INTEGER; BEGIN
  ...
  IF pid IS NOT NULL THEN
    INSERT INTO product_variants (product_id, formato, precio, imagen_url, orden)
    VALUES (pid, '125 g', 0.00, 'https://grupolambea.com/wp-content/uploads/2021/09/20200202_210507.jpg', 0)
    ON CONFLICT (product_id, formato) DO UPDATE SET precio = EXCLUDED.precio, imagen_url = EXCLUDED.imagen_url;
    INSERT INTO product_variants (product_id, formato, precio, imagen_url, orden)
...
DO $$ DECLARE pid INTEGER; BEGIN
  ...
  IF pid IS NOT NULL THEN
    INSERT INTO product_variants (product_id, formato, precio, imagen_url, orden)
    VALUES (pid, '125 g', 0.00, 'https://grupolambea.com/wp-content/uploads/2023/07/PLASTILAM-INDUSTRIAL-125-g-2-scaled.jpg', 0)
    ON CONFLICT (product_id, formato) DO UPDATE SET precio = EXCLUDED.precio, imagen_url = EXCLUDED.imagen_url;
    INSERT INTO product_variants (product_id, formato, precio, imagen_url, orden)
