...
import { ProductCard, type MockProduct } from '@/components/ProductCard'
...
const FEATURED: MockProduct[] = [
  {
    ...
    familia: 'DESOXILAM',
    descripcion_corta: 'Desoxidante enérgico concentrado con efecto pasivante',
    aplicaciones: ['nautico'],
    precio_desde: 7.5,
    imagen: '/assets/productos/desoxilam.jpg',
    valoracion: 5,
    num_valoraciones: 7,
  },
  {
    ...
    familia: 'FIBRALAM',
    descripcion_corta: 'Limpiador y blanqueador 2 en 1 para fibra de vidrio y gelcoat',
    aplicaciones: ['nautico'],
    precio_desde: 17.5,
    imagen: '/assets/productos/prod-nautico-02.jpg',
    valoracion: 5,
    num_valoraciones: 1,
  },
  {
    ...
    familia: 'MOTORLAM',
    descripcion_corta: 'Desengrasante de motores de alto rendimiento',
    aplicaciones: ['nautico', 'industrial'],
    precio_desde: 18.15,
    imagen: '/assets/productos/motorlam-nautico.jpg',
    valoracion: 5,
    num_valoraciones: 2,
  },
  {
    slug: 'inyeclam-diesel-industrial',
    familia: 'INYECLAM DIESEL',
    descripcion_corta: 'Aditivo limpiador de inyectores. Pre-ITV',
    aplicaciones: ['industrial'],
    precio_desde: 18.0,
    imagen: '/assets/productos/inyeclam-diesel.jpg',
    valoracion: 5,
    num_valoraciones: 3,
  },
]
      ...
      <section className="relative min-h-[580px] overflow-hidden flex items-center bg-[var(--blue-deep)]">
        ...
        >
          ...
          >
            ...
            >
              <span className="font-(family-name:--font-lora) text-[22px] leading-none">3×2</span>
            ...
            >
              <div className="relative w-[78%] h-full">
                <Image
                  src="/assets/productos/desoxilam.jpg"
                  alt="Desoxilam Náutico"
                  fill
            ...
            <p className="text-[13px] text-[var(--ink-500)] leading-relaxed mb-3.5">
              Desoxidante enérgico concentrado con efecto pasivante
            </p>
            ...
            >
              ...
              <span className="text-[var(--warning)] text-[13px] tracking-wider">★★★★★</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="bg-[var(--bg-soft)] py-8">
        <div className="max-w-[1320px] mx-auto px-4 md:px-8 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-7">
          {[
            ...
            { Icon: Truck, title: 'Envío gratis a Península', sub: '50% off para Baleares' },
      ...
      <section className="py-[100px] bg-white">
        <div className="max-w-[1320px] mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              { slug: 'desoxilam-nautico', name: 'Desoxilam',  tag: 'Náutico · Desoxidante' },
              { slug: 'fibralam-nautico',  name: 'Fibralam',   tag: 'Náutico · Limpieza de casco' },
              { slug: 'motorlam-nautico',  name: 'Motorlam',   tag: 'Náutico · Desengrasante' },
            ].map(({ slug, name, tag }) => (
        ...
        <div className="max-w-[1320px] mx-auto px-4 md:px-8 grid gap-12 md:gap-20 items-center grid-cols-1 lg:grid-cols-[1fr_1.1fr]">
          ...
          <div>
            ...
            <p className="text-[16px] text-[var(--ink-700)] leading-[1.8] mb-4">
              Grupo Lambea es una empresa familiar fundada en 1952 por el &quot;Abuelo Lambea&quot;. En sus inicios fue una de
            ...
            >
              <span
                className="absolute top-[-2px] left-3.5 font-[64px] text-[var(--blue)] leading-none opacity-35 font-serif text-[64px]"
                aria-hidden="true"
              >
                &quot;
              </span>
          ...
          {[
            {
              content: (
                <span
                  ...
                  style={{ fontSize: 48, color: '#B3DEF2', letterSpacing: '-0.03em' }}
                >
                  3×2
                </span>
              ),
              title: 'Promo permanente',
              sub: 'Llévate tres y paga solo dos en todo el catálogo. Se aplica automáticamente en el carrito.',
            },
            {
              icon: <Truck size={30} strokeWidth={1.4} />,
              title: 'Envío gratis',
              sub: 'A toda la Península en pedidos superiores a 60 €. Entrega en 24–48 h laborables.',
            },
            {
              icon: <FlaskConical size={30} strokeWidth={1.4} />,
              title: 'Fórmula registrada',
              sub: 'Reg. Tox. DRP19-0005580. Productos homologados, biodegradables y fabricados en España.',
            },
            {
        ...
        <div className="max-w-[1320px] mx-auto px-4 md:px-8">
          <div className="text-center mb-14">
            ...
            <div className="flex items-center justify-center gap-2 mt-2">
              <div className="flex gap-0.5">
                {[1, 2, 3, 4, 5].map((s) => (
                  <Star key={s} size={16} fill="#E8A93C" stroke="#E8A93C" />
                ))}
              </div>
              <span className="font-semibold text-[var(--ink)] text-[15px]">4.9</span>
              <span className="text-[var(--ink-500)] text-[13px]">· más de 200 valoraciones</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              {
                name: 'José M.',
                role: 'Patrón de velero',
                rating: 5,
                text: 'Llevaba años buscando algo que funcionara de verdad en el casco. Desde que uso DESOXILAM no necesito nada más. El resultado es inmediato y dura toda la temporada.',
              },
              {
                name: 'Carmen R.',
                role: 'Caravaning',
                rating: 5,
                text: 'Lo recomendé a todo el camping. La caravana queda perfecta sin tener que frotar demasiado. Llevo dos temporadas usándolo y no cambiaría de producto.',
              },
              {
                name: 'Antonio P.',
                role: 'Taller mecánico',
                rating: 5,
                text: 'Para el taller es perfecto. Rinde mucho más de lo que esperas por el precio, y el servicio del equipo de Lambea es de los mejores que he tenido con un proveedor.',
              },
            ].map((t, i) => (
              <div key={i} className="flex flex-col">
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold text-[var(--ink)] text-[13.5px]">{t.name}</div>
                    <div className="text-[11.5px] text-[var(--ink-500)]">{t.role}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-16 bg-[var(--bg-soft)]">
        <div className="max-w-[1320px] mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-3 md:grid-cols-5 gap-4 md:gap-6">
            {[
              { src: '/assets/empresa/empresa1.png', alt: 'Partner Grupo Lambea' },
              { src: '/assets/empresa/empresa2.png', alt: 'Partner Grupo Lambea' },
              { src: '/assets/empresa/empresa3.png', alt: 'Partner Grupo Lambea' },
              { src: '/assets/empresa/empresa4.png', alt: 'Partner Grupo Lambea' },
              { src: '/assets/empresa/empresa5.png', alt: 'Partner Grupo Lambea' },
            ].map(({ src, alt }, i) => (
              <div
                key={i}
