...
import { Copy, Check, X, Search, Upload, ImagePlus, Loader2, ArrowDown } from 'lucide-react';
      ...
      <div className="flex flex-wrap items-center gap-3 mb-5">
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="Buscar por nombre, familia o URL…"
            className="pl-9 pr-4 py-2 border border-[#e5e7eb] rounded-lg text-[13px] outline-none focus:border-blue transition-colors bg-white w-72"
          />
        </div>
        {search && (
